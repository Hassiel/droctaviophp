...
<html data-wf-page="604bc29a97a17b04b73d95a4" data-wf-site="5fb84b55d6eff209e92250ed">
<head>
  <meta charset="utf-8">
  <title>Creación de Post</title>
  <meta content="Creación de Post" property="og:title">
  <meta content="Creación de Post" property="twitter:title">
...
<body>
  ...
  <div class="sectionextra publish">
    <div class="w-form">
      <form id="email-form" name="email-form" data-name="Email Form">
        ...
        </select><label for="description" class="creationlabel">Contenido</label>
        ...
        <label for="youtube" class="creationlabel">Link de Youtube</label>
        <input type="text" class="creationinput w-input" maxlength="256" name="youtube" data-name="youtube" placeholder="link" id="youtbe">
  ...
  <footer id="footer" class="footer section-3">
